...
(NULL,@ord3,'Large','Original','completed',@dt3,14.88,3.30);
INSERT INTO pizza VALUES
(NULL,@ord6,'Large','Thin','completed','2025-01-02 18:17:00',25.81,3.64);
INSERT INTO pizza VALUES
(NULL,@ord1,'Large','Thin','completed','2025-01-05 12:03:00',19.75,3.68);
INSERT INTO pizza VALUES
(NULL,@ord7,'Large','Thin','completed','2025-02-13 20:32:00',18.00,2.75);
INSERT INTO pizza VALUES
(NULL,@ord7,'Large','Thin','completed','2025-02-13 20:32:00',19.25,3.25);
INSERT INTO pizza VALUES
(NULL,@ord2,'Small','Original','completed','2025-02-03 12:05:00',6.93,1.40);
INSERT INTO pizza VALUES
(NULL,@ord2,'Medium','Pan','completed','2025-02-03 12:05:00',13.85,3.23);
INSERT INTO pizza VALUES
(NULL,@ord5,'XLarge','Gluten-Free','completed','2025-01-02 17:30:00',28.70,7.84);
INSERT INTO pizza VALUES
(NULL,@ord4,'XLarge','Original','completed','2025-02-20 19:11:00',26.75,5.55);
INSERT INTO pizza VALUES
(NULL,@ord4,'XLarge','Original','completed','2025-02-20 19:11:00',27.94,5.59);
INSERT INTO pizza VALUES
(NULL,@ord4,'XLarge','Original','completed','2025-02-20 19:11:00',31.50,6.25);
...
SELECT @p6 := @p1 + 5;
SELECT @p7 := (
  SELECT pizza_PizzaID
  FROM pizza
  WHERE ordertable_OrderID=@ord6
  LIMIT 1
);
SELECT @p8 := (
  SELECT pizza_PizzaID
  FROM pizza
  WHERE ordertable_OrderID=@ord1
  LIMIT 1
);
SELECT @p9 := (
  SELECT MIN(pizza_PizzaID)
  FROM pizza
  WHERE ordertable_OrderID=@ord7
);
SELECT @p10 := @p9 + 1;
SELECT @p11 := (
  SELECT MIN(pizza_PizzaID)
  FROM pizza
  WHERE ordertable_OrderID=@ord2
);
SELECT @p12 := @p11 + 1;
SELECT @p13 := (
  SELECT pizza_PizzaID
  FROM pizza
  WHERE ordertable_OrderID=@ord5
  LIMIT 1
);
SELECT @p14 := (
  SELECT MIN(pizza_PizzaID)
  FROM pizza
  WHERE ordertable_OrderID=@ord4
);
SELECT @p15 := @p14 + 1;
SELECT @p16 := @p14 + 2;

INSERT INTO pizza_discount
  SELECT @p8, discount_DiscountID
  FROM discount
  WHERE discount_DiscountName='Lunch Special Large';
INSERT INTO order_discount
  SELECT @ord2, discount_DiscountID
  FROM discount
  WHERE discount_DiscountName='Lunch Special Medium';
INSERT INTO pizza_discount
  SELECT @p12, discount_DiscountID
  FROM discount
  WHERE discount_DiscountName='Specialty Pizza';
INSERT INTO order_discount
  SELECT @ord4, discount_DiscountID
  FROM discount
  WHERE discount_DiscountName='Gameday Special';
INSERT INTO pizza_discount
  SELECT @p13, discount_DiscountID
  FROM discount
  WHERE discount_DiscountName='Specialty Pizza';
INSERT INTO order_discount
  SELECT @ord7, discount_DiscountID
  FROM discount
  WHERE discount_DiscountName='Employee';
INSERT INTO pizza_discount
  SELECT @p16, discount_DiscountID
  FROM discount
  WHERE discount_DiscountName='Specialty Pizza';
