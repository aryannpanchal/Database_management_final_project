...
public class DBNinja {
    ...
    // Order types (must match PopulateData.sql)
    public static final String dine_in  = "dinein";
    public static final String pickup   = "pickup";
    public static final String delivery = "delivery";

    // Order state enum that the autograder references
    public enum order_state {
        PREPARED, // used by the autograder
        PICKEDUP,
        DELIVERED,
        COMPLETED
    }
    ...
    public static void addOrder(Order o) throws SQLException, IOException {
        ...
        try {
            ...
            String insertOrder = "INSERT INTO ordertable " +
            ...
            if (o.getOrderType().equals(dine_in) && o instanceof DineinOrder) {
                ...
                String addr = d.getAddress(); // assumes DeliveryOrder has getAddress()
                int houseNum = 0;
                String street = "";
                String city = "";
                String state = "";
    ...
    public static int addPizza(Date d, int orderID, Pizza p) throws SQLException, IOException {
        ...
        // 1) Insert pizza row
        String insertPizza = "INSERT INTO pizza " +
        ...
        for (Topping t : p.getToppings()) {
            ...
            String insertTop = "INSERT INTO pizza_topping " +
        ...
        for (Discount dsc : p.getDiscounts()) {
            String insertDisc = "INSERT INTO pizza_discount (pizza_PizzaID, discount_DiscountID) VALUES (?, ?)";
    ...
    public static void completeOrder(int orderID, order_state state) throws SQLException, IOException {
        ...
        // Also mark pickup/delivery as picked up / delivered
    ...
    public static ArrayList<Discount> getDiscounts(Order o) throws SQLException, IOException {
        ...
        ArrayList<Discount> list = new ArrayList<>();
        String sql = "SELECT d.discount_DiscountID, d.discount_DiscountName, d.discount_Amount, d.discount_IsPercent " +
                     "FROM discount d " +
    ...
    public static void printProfitByOrderTypeReport() throws SQLException, IOException {
        ...
        String sql = "SELECT CustomerType, OrderMonth, TotalOrderPrice, TotalOrderCost, Profit FROM ProfitByOrderType";
        try (Statement st = conn.createStatement();
             ResultSet rs = st.executeQuery(sql)) {
    ...
    // -------------------------
    // Helper: build Order from ResultSet
    // -------------------------
    ...
    private static Order buildOrderFromResultSet(ResultSet rs) throws SQLException, IOException {
        ...
        if (orderType.equals(dine_in)) {
            ...
            String sql = "SELECT delivery_HouseNum, delivery_Street, delivery_City, " +
                         "delivery_State, delivery_Zip, delivery_IsDelivered " +
